...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'newPasswordConfirm' => Yii::t('user', 'Confirm Password'),
        ];
    }
    ...
    {
        return $this->profile->full_name ?: $this->username ?: $this->email ?: $this->id;
    }
    ...
    public function sendEmailConfirmation($userToken)
    {
        ...
        $subject = Yii::t("user", "Please confirm your account on Tdot Academy.");
